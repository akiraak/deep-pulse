---
url: https://appwrite.io/blog/post/vibe-coding-security-best-practices
title: "20 security best practices for vibe coding - Appwrite"
---

![20 security best practices for vibe coding](/images/blog/vibe-coding-security-best-practices/cover.png){.block .aspect-video .object-cover active="" fetchpriority="high" height="822" loading="eager" width="1463"}
...
``` {.web-code .language-js .line-numbers}
...
``` {.web-code .language-sh .line-numbers}
/search?name=' OR '1'='1
```
...
## Build fast, scale faster {#build-fast-scale-faster .text-label .text-primary .font-aeonik-pro .text-pretty}

Backend infrastructure and web hosting built for developers who ship.

-   ![](/images/icons/colored/check.svg){.block .shrink-0 .self-start .leading-none height="20" width="20"} [Start for free]{.min-w-0 .flex-1 .leading-snug}
-   ![](/images/icons/colored/check.svg){.block .shrink-0 .self-start .leading-none height="20" width="20"} [Open source]{.min-w-0 .flex-1 .leading-snug}
-   ![](/images/icons/colored/check.svg){.block .shrink-0 .self-start .leading-none height="20" width="20"} [Support for over 13 SDKs]{.min-w-0 .flex-1 .leading-snug}
-   ![](/images/icons/colored/check.svg){.block .shrink-0 .self-start .leading-none height="20" width="20"} [Managed cloud solution]{.min-w-0 .flex-1 .leading-snug}

[Start building for free](https://cloud.appwrite.io/){.web-button .blog-inline-promo__btn .max-sm:w-full!}
